...
void HelloTriangleApplication::createSurface() {
    if (glfwCreateWindowSurface(instanced, window, nullptr, &surface) != VK_SUCCESS) {
...
void HelloTriangleApplication::createLogicalDevice() {
    ...
    createInfo.enabledExtensionCount = static_cast<uint32_t>(AppConfigConstants::deviceExtensions.size());
    createInfo.ppEnabledExtensionNames = AppConfigConstants::deviceExtensions.data();
...
bool HelloTriangleApplication::checkDeviceExtensionSupport(VkPhysicalDevice device) {
    ...
    std::set<std::string> requiredExtensions(AppConfigConstants::deviceExtensions.begin(), AppConfigConstants::deviceExtensions.end());
...
void HelloTriangleApplication::cleanup() {
    ...
    vkDestroySurfaceKHR(instanced, surface, nullptr);
